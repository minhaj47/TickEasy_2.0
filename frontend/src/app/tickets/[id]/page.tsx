...
export default function TicketPage() {
  ...
  if (!ticket) return <div className="text-center py-10">Loading...</div>;
        ...
        <div className="p-8">
          ...
          <div className="flex items-start justify-between mb-6">
            ...
            <div className="flex flex-col items-center bg-gradient-to-br from-violet-50 to-indigo-50 border border-violet-200 rounded-xl p-4 min-w-[80px] ml-6">
              <span className="text-2xl font-bold text-violet-700">{day}</span>
          ...
          <div className="mt-6 p-4 bg-amber-50 border border-amber-200 rounded-xl">
            <p className="text-sm text-amber-800">
              <strong>Important:</strong> Please present this ticket (digital or
              printed) along with a valid ID for entry. Ticket is
