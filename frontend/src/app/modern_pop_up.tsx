...
const ModernPopUp: React.FC<PopupProps> = ({
  isOpen,
  onClose,
  title,
  message,
  ...
  const getSecondaryButtonStyle = () => {
    ...
    switch (variant) {
      case "outline":
        return "border border-white/30 text-gray-200 hover:bg-white/10";
      default:
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4">
      <div className="bg-gradient-to-br from-slate-900 via-violet-900/50 to-indigo-900 rounded-2xl shadow-2xl max-w-lg w-full mx-4 overflow-hidden animate-fade-in border border-white/20">
        {/* Header */}
        ...
        {/* Footer with buttons */}
        <div className="px-8 py-6 border-t border-white/20 flex space-x-4 justify-end">
          <button
            onClick={() => {
