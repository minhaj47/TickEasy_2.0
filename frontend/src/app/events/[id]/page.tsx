  ...
  return (
    <>
      <SEO
        ...
        image="/slight_dark.png"
        url={`https://event-grid-2-0.vercel.app/events/${eventId}`}
      />
      <main>
                    ...
                    {!registrationSuccess && (
                      <div className="mt-6 mb-6 p-4 bg-blue-50 rounded-xl border border-blue-100">
                        <h4 className="font-semibold text-blue-800 mb-2">
                          Pay First and then Fill up the form by clicking the
                          button below
                        </h4>
                      </div>
                    )}
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    ...
                    <div className="mt-6 p-4 bg-violet-50 rounded-xl border border-violet-100">
                      ...
                      <ul className="text-sm text-violet-700 space-y-2">
                        ...
                        <li>
                          • <strong>Complete payment</strong> - Finish your
                          payment and wait for confirmation
                        </li>
                        <li>
                          • <strong>Check your email</strong> - Your basic
                          ticket will be sent once payment is confirmed
                        </li>
                        <li>
                          • <strong>Create account (optional)</strong> -
                          Register and login to view all ticket details and
                          manage bookings
                        </li>
                      </ul>
                      <h4 className="font-semibold text-violet-800 mb-2">
                  ...
                  <div className="mb-6 p-4 bg-violet-50 rounded-xl border border-violet-100">
                    ...
                    {event.ticketPrice && event.ticketPrice > 0 && (
                      <div className="space-y-2 text-sm text-violet-700">
                        ...
                        <p>
                          <strong>Step 3:</strong> Wait for payment
                          confirmation. Once confirmed we will send you a ticket
                          via email.
                        </p>
                        <p>
                    ...
                    <div className="mt-3 p-2 bg-violet-100 rounded-lg">
                      <p className="text-xs text-violet-600">
                        ...
                        transaction ID. For Cash Payment Provide enough details
